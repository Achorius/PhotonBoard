...
const USB_DRIVERS: { value: UsbDmxDriver; label: string; description: string }[] = [
  { value: 'enttec-open-dmx', label: 'ENTTEC Open DMX USB', description: 'FTDI 250kbaud' },
  { value: 'enttec-pro', label: 'ENTTEC DMX USB Pro', description: 'Pro protocol' },
  { value: 'eurolite', label: 'Eurolite USB-DMX512', description: 'FTDI 250kbaud' },
  { value: 'showtec', label: 'Showtec Quick DMX', description: 'FTDI 250kbaud' },
  { value: 'beamz', label: 'Beamz DMX60 / DMX70', description: 'FTDI 250kbaud' },
  { value: 'velleman', label: 'Velleman VM116 / K8062', description: 'FTDI 250kbaud' },
  { value: 'stairville', label: 'Stairville USB-DMX', description: 'FTDI 250kbaud' },
  { value: 'udmx', label: 'uDMX / Anyma / Clone', description: 'FTDI 250kbaud' },
  { value: 'generic-ftdi', label: 'Generic FTDI Adapter', description: 'FTDI 250kbaud' },
]
          ...
          <section className="panel p-4 space-y-3">
            ...
            {artnetConfigs.map((config, i) => (
              <div key={i} className="flex items-center gap-2 bg-surface-2 rounded p-2">
                <span className="text-xs text-gray-500 w-16 shrink-0">Univ {i + 1}</span>
